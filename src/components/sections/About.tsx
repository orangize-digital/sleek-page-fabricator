            ...
            <div className="space-y-6">
              ...
              <div className="reveal">
                <p className="text-gray-700 mb-6">
                  Seit mehr als zwei Jahrzehnten steht Metallbaumeister Albrecht
                  für höchste Qualität und Präzision in der Metallverarbeitung.
                  Als Familienbetrieb verbinden wir traditionelles Handwerk mit
                  modernen Technologien, um maßgeschneiderte Lösungen zu
                  schaffen, die sowohl funktional als auch ästhetisch
                  überzeugen.
                </p>
              </div>
              <div className="reveal">
                <p className="text-gray-700 mb-6">
                  Albert Albrecht gründete das Unternehmen 1998 mit der Vision,
                  hochwertige Metallarbeiten für anspruchsvolle Kunden zu
                  realisieren. Heute führt er den Betrieb mit einem Team von
                  qualifizierten Fachkräften, die seine Leidenschaft für
                  Perfektion teilen.
                </p>
              </div>
              <div className="reveal">
                <p className="text-gray-700">
                  Unsere Stärke liegt in der individuellen Beratung und der
                  präzisen Umsetzung komplexer Anforderungen. Vom ersten
                  Gespräch bis zur finalen Montage begleiten wir unsere Kunden
                  und verwirklichen ihre Ideen in beständigem Metall.
                </p>
              </div>
