      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="max-w-3xl animate-fade-in">
          ...
          <div className="flex flex-col sm:flex-row gap-5 sm:gap-6">
            ...
            <Button 
              variant="outline"
              className="bg-white/15 backdrop-blur-sm hover:bg-white/25 text-white border-2 border-white/40 px-8 py-7 rounded-lg font-medium text-base transition-all duration-300"
              asChild
            >
              <a href="#projects">
                Projekte ansehen
